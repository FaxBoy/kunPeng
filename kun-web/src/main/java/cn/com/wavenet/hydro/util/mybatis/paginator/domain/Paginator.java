package cn.com.wavenet.hydro.util.mybatis.paginator.domain;
...
public class Paginator implements Serializable {
    ...
    /**
     * 
    * @Title: getReqPaginator 
    * @Description: TODO(序列化分页) 
    * @param @param req
    * @param @return    设定文件 
    * @return Paginator    返回类型 
    * @author shil 
    * @date 2017年5月27日 下午1:26:40 
    * @throws
     */
    public static Paginator getReqPaginator(HttpServletRequest req) {
		...
		Map<String, String> params = JSONObject.parseObject(sb.toString(), new TypeReference<Map<String, String>>(){});
		
		JSONObject json = JSONObject.parseObject(sb.toString());
		Paginator page = new Paginator(Integer.parseInt(json.getString("offset").toString())/Integer.parseInt(json.getString("limit").toString())+1,
				Integer.parseInt(json.get("limit").toString()));
		page.setParamsMap(params);
		return page;
	}
    
    public static Paginator getPaginatorParam(Map map){
    	Paginator page = new Paginator(Integer.parseInt(map.get("page").toString()),
