...
(function (e, d, a, f) {
    ...
    var c = function (j, h) {
        this.$element = e(j);
        this.options = e.extend({}, e.fn.twbsPagination.defaults, h);//alert(this.options.startPage+"-"+this.options.totalPages);
        if ((this.options.startPage < 1 || this.options.startPage > this.options.totalPages)&&this.options.totalPages!=0) {
